...
export const Character = ({ character, onFollow = _NOOP, isFollowing = false }) => {
	const { image, name, status, location, gender, species, type, origin } = character
			...
			<div className='flex-1 flex flex-col font-black text-xl'>
				...
				<span>
					<button
						...
						style={isFollowing ? { backgroundColor: 'red', opacity: 0.6 } : {}}
